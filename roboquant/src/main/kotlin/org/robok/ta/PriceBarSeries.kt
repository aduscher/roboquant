...
open class PriceBarSeries(capacity: Int) {
    ...
    protected val openBuffer = _root_ide_package_.org.robok.common.PriceSeries(capacity)
    protected val highBuffer = _root_ide_package_.org.robok.common.PriceSeries(capacity)
    protected val lowBuffer = _root_ide_package_.org.robok.common.PriceSeries(capacity)
    protected val closeBuffer = _root_ide_package_.org.robok.common.PriceSeries(capacity)
    protected val volumeBuffer = _root_ide_package_.org.robok.common.PriceSeries(capacity)
     ...
     */
    open fun add(priceBar: org.robok.common.PriceBar, time: Instant): Boolean {
     ...
     */
    operator fun get(timeframe: org.robok.common.Timeframe): PriceBarSeries {
