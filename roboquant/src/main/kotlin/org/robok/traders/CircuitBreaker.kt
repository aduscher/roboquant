 ...
 */
class CircuitBreaker(val trader: Trader, private val maxOrders: Int, private val period: org.robok.common.TimeSpan) :
    Trader by trader {
 ...
 * ```
 */
fun Trader.circuitBreaker(maxOrders: Int, period: org.robok.common.TimeSpan): Trader = CircuitBreaker(this, maxOrders, period)
