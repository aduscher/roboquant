...
data class CSVConfig(
    ...
    companion object {
        ...
        private val logger = _root_ide_package_.org.robok.common.Logging.getLogger(CSVConfig::class)
        ...
        fun stooq(): CSVConfig {
            ...
            return CSVConfig(
                ...
                assetBuilder = { name: String ->
                    _root_ide_package_.org.robok.common.Stock(
        ...
        fun mt5(
            ...
            timeSpan: org.robok.common.TimeSpan? = null
        ): CSVConfig {

            fun assetBuilder(name: String): org.robok.common.Asset {
                val symbol = name.split('_').first().uppercase()
                return _root_ide_package_.org.robok.common.Stock(symbol, CurrencyK.USD)
            }
        ...
        fun histData(): CSVConfig {
            val result = CSVConfig(
                ...
                assetBuilder = { name: String ->
                    ...
                    _root_ide_package_.org.robok.common.Forex(symbol, currency.second)
                }
            )
            return result
        }
         ...
         *
         */
        fun yahoo(currency: CurrencyK = CurrencyK.USD): CSVConfig {
            val result = CSVConfig(
                ...
                assetBuilder = { name: String ->
                    ...
                    _root_ide_package_.org.robok.common.Stock(symbol = symbol, currency)
                }
            )
            return result
        }
        ...
        fun kraken(): CSVConfig {
            val result = CSVConfig(
                ...
                assetBuilder = { name: String ->
                    ...
                    _root_ide_package_.org.robok.common.Crypto(name, currencyPair.second)
                }
            )
            return result
        }
     ...
     * @return
     */
    internal fun processLine(line: List<String>, asset: org.robok.common.Asset): PriceEntry {
