 ...
 * the [org.robok.common.Account] object.
 *
 ...
 */
class InternalAccount(override var baseCurrency: org.robok.common.CurrencyK) : org.robok.common.Account {
     ...
     * Open orders
     */
    override val orders = mutableListOf<org.robok.common.Order>()


    /**
     * Total cash balance hold in this account. This can be a single currency or multiple currencies.
     */
    override val cash: org.robok.common.Wallet = _root_ide_package_.org.robok.common.Wallet()

    /**
     * Remaining buying power of the account denoted in the [InternalAccount.baseCurrency] of the account.
     */
    override var buyingPower: org.robok.common.Amount = _root_ide_package_.org.robok.common.Amount(baseCurrency, 0.0)

    /**
     * Trades that happened to far
     */
    override val trades = mutableListOf<org.robok.common.Trade>()

    /**
     * Portfolio with its open positions. Positions are removed as soon as they are closed
     */
    override val positions = mutableMapOf<org.robok.common.Asset, org.robok.common.Position>()
     ...
     */
    fun deleteOrder(order: org.robok.common.Order) {
     ...
     */
    @Synchronized
    fun setPosition(asset: org.robok.common.Asset, position: org.robok.common.Position) {
        if (position.closed) {
     ...
     */
    fun updateMarketPrices(event: EventK, priceType: String = "DEFAULT") {
    ...
    /**
     * Create an [org.robok.common.Account] instance
     */
    @Synchronized
    fun toAccount(): org.robok.common.Account {
        return this
    }
