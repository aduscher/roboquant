 ...
 */
class FixedExchangeRates(var baseCurrency: CurrencyK, exchangeRates: Map<CurrencyK, Double>) : ExchangeRates {

    private val exchangeRates = ConcurrentHashMap(exchangeRates)

    constructor(baseCurrency: CurrencyK, vararg rates: Pair<CurrencyK, Double>) : this(baseCurrency, rates.toMap())
     ...
     */
    fun setRate(currency: CurrencyK, rate: Double) {
