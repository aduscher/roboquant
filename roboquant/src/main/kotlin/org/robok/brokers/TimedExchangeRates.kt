 ...
 */
abstract class TimedExchangeRates(protected val baseCurrency: CurrencyK) : ExchangeRates {

    protected val exchangeRates = mutableMapOf<CurrencyK, NavigableMap<Instant, Double>>()

    /**
     * Currencies available
     */
    val currencies: Collection<CurrencyK>
        get() = exchangeRates.keys + setOf(baseCurrency)

    private fun find(currency: CurrencyK, time: Instant): Double {
     ...
     */
    override fun getRate(amount: Amount, to: CurrencyK, time: Instant): Double {
