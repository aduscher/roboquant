...
class Wallet(private val data: IdentityHashMap<CurrencyK, Double> = IdentityHashMap(1)) : Cloneable {
    ...
    companion object {
        ...
        operator fun invoke(amount: Amount): Wallet {
            val data = IdentityHashMap<CurrencyK, Double>(1)
     ...
     */
    operator fun get(currency: CurrencyK): Double = data[currency] ?: 0.0
     ...
     * values
     */
    fun set(currency: CurrencyK, value: Double) {
     ...
     */
    fun deposit(currency: CurrencyK, value: Double) {
    ...
    public override fun clone(): Wallet = Wallet(data.clone() as IdentityHashMap<CurrencyK, Double>)
    ...
    /**
     * Returns a map where the key is the [CurrencyK] and the value is the amount.
     */
    fun toMap(): Map<CurrencyK, Double> = data.toMap()
     ...
     */
    fun convert(currency: CurrencyK, time: Instant): Amount {
