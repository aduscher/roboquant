...
import org.robok.common.Asset.Companion.SEP
...
private fun deserializeOption(value: String): Asset {
    ...
    return Option(symbol, CurrencyK.getInstance(currencyCode))
}
 ...
 */
data class Option(override val symbol: String, override val currency: CurrencyK) : Asset {
...
private fun deserializeCrypto(value: String): Asset {
    val (symbol, currencyCode) = value.split(SEP)
    return Crypto(symbol, CurrencyK.getInstance(currencyCode))
}
 ...
 */
data class Crypto(override val symbol: String, override val currency: CurrencyK) : Asset {
...
private fun deserializeStock(value: String): Asset {
    val (symbol, currencyCode) = value.split(SEP)
    return Stock(symbol, CurrencyK.getInstance(currencyCode))
}
 ...
 */
data class Stock(override val symbol: String, override val currency: CurrencyK = CurrencyK.USD) : Asset {
...
private fun deserializeForex(value: String): Asset {
    val (symbol, currencyCode) = value.split(SEP)
    return Forex(symbol, CurrencyK.getInstance(currencyCode))
}
 ...
 */
data class Forex(override val symbol: String, override val currency: CurrencyK) : Asset {
