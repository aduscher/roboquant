...
public final class Crypto implements Asset {
   ...
   public Crypto(@NotNull String symbol, @NotNull Currency currency) {
   ...
   public String serialize() {
      ...
      return "Crypto;" + var10000 + ";" + this.getCurrency();
   }
   ...
   @NotNull
   public final Crypto copy(@NotNull String symbol, @NotNull Currency currency) {
      Intrinsics.checkNotNullParameter(symbol, "symbol");
      Intrinsics.checkNotNullParameter(currency, "currency");
      return new Crypto(symbol, currency);
   }

   // $FF: synthetic method
   public static Crypto copy$default(Crypto var0, String var1, Currency var2, int var3, Object var4) {
      if ((var3 & 1) != 0) {
         var1 = var0.symbol;
      }
   ...
   public String toString() {
      return "Crypto(symbol=" + this.symbol + ", currency=" + this.currency + ")";
   }
   ...
   public boolean equals(@Nullable Object other) {
      if (this == other) {
         return true;
      } else if (!(other instanceof Crypto)) {
         return false;
      } else {
         Crypto var2 = (Crypto)other;
   ...
   @Metadata(
      ...
      d2 = {"Lorg/roboquant/common/Crypto$Companion;", "", "()V", "deserialize", "Lorg/roboquant/common/Asset;", "value", "", "fromSymbol", "Lorg/roboquant/common/Crypto;", "symbol", "roboquant"}
   )
   public static final class Companion {
      ...
      public final Asset deserialize(@NotNull String value) {
         ...
         return new Crypto(symbol, Currency.Companion.getInstance(currencyCode));
      }

      @NotNull
      public final Crypto fromSymbol(@NotNull String symbol) {
         Intrinsics.checkNotNullParameter(symbol, "symbol");
         return new Crypto(symbol, Currency.Companion.getUSD());
      }
