...
internal class ReturnsMetricTest {
    ...
    @Test
    fun basic() {
        val metric = _root_ide_package_.org.robok.journals.metrics.ReturnsMetric()
    ...
    @Test
    fun basic2() {
        val metric = _root_ide_package_.org.robok.journals.metrics.ReturnsMetric2(minSize = 250)
