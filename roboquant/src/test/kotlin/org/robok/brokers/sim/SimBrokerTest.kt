...
internal class SimBrokerTest {
    ...
    private fun getFilledSimbroker(): SimBroker {
        val broker = SimBroker()
        val asset = _root_ide_package_.org.robok.common.Stock("TEST")
        val order =
            _root_ide_package_.org.robok.common.Order(asset, _root_ide_package_.org.robok.common.Size(10), 100.0)
        val price = _root_ide_package_.org.robok.common.TradePrice(asset, 100.0)
        val now = Instant.now()
        val event = _root_ide_package_.org.robok.common.EventK(now, listOf(price))
    ...
    fun updateOrder() {
        val broker = SimBroker()
        val asset = _root_ide_package_.org.robok.common.Stock("TEST")
        val order = _root_ide_package_.org.robok.common.Order(asset, Size.ONE, 99.0)
        val price = _root_ide_package_.org.robok.common.TradePrice(asset, 100.0)
        val now = Instant.now()
        val event = _root_ide_package_.org.robok.common.EventK(now, listOf(price))
        ...
        val event2 = _root_ide_package_.org.robok.common.EventK(now + 1.millis, listOf(price))
