...
import org.robok.brokers.CashAccountModel
...
internal class CashAccountTest {
    ...
    fun testCashAccount() {
        ...
        val abc = _root_ide_package_.org.robok.common.Stock("ABC", EUR)
        val xyz = _root_ide_package_.org.robok.common.Stock("XYZ")
