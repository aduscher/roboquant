...
internal class AssetTest {
    ...
    @Test
    fun basic() {
        val a = _root_ide_package_.org.robok.common.Stock("ABC")
        val c = _root_ide_package_.org.robok.common.Stock("ABC")
    ...
    @Test
    fun option() {
        val a = _root_ide_package_.org.robok.common.Option("ABC", CurrencyK.USD)
        val s = a.serialize()
