...
internal class AggregatorFeedTest {
    ...
    fun basic() {
        ...
        val aggFeed = _root_ide_package_.org.robok.feeds.AggregatorFeed(feed, 15.minutes)
    ...
    fun aggregatorFeed2() {
        ...
        val ts = 15.minutes
        val aggFeed = _root_ide_package_.org.robok.feeds.AggregatorFeed(feed, ts)
    ...
    fun basic2() {
        ...
        val aggFeed = _root_ide_package_.org.robok.feeds.AggregatorFeed(feed, 1.seconds)
        val items2 = aggFeed.toList()
        assertTrue(items2.isNotEmpty())
    ...
    fun combined() {
        ...
        val aggFeed1 = _root_ide_package_.org.robok.feeds.AggregatorFeed(rw, 1.seconds)
        ...
        val aggFeed2 = _root_ide_package_.org.robok.feeds.AggregatorFeed(rw, 2.seconds)
        ...
        val feed = _root_ide_package_.org.robok.feeds.CombinedFeed(aggFeed1, aggFeed2)
