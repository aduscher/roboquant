...
internal class PriceParserTest {
    ...
    @Test
    fun priceBarParser() {
        val parser = _root_ide_package_.org.robok.feeds.csv.PriceBarParser()
    ...
    fun priceBarParser2() {
        val parser =
            _root_ide_package_.org.robok.feeds.csv.PriceBarParser(open = 4, high = 3, low = 2, close = 1, volume = 5)
        val asset = Stock("TEST")
    ...
    fun priceQuoteParser() {
        val parser = _root_ide_package_.org.robok.feeds.csv.PriceQuoteParser()
